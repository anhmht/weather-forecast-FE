...
export const SUPER_CATEGORY = [
    CATEGORY.LIST_POST_WEATHER_NEWS,
    CATEGORY.LIST_POST_WEATHER_MAP
];

export const KTTV_CATEGORY = [
    CATEGORY.LIST_POST_CANH_BAO_THIEN_TAI,
    CATEGORY.LIST_POST_THONG_TIN_KHUYEN_CAO,
    CATEGORY.LIST_POST_KT_VH_XH,
    CATEGORY.LIST_POST_THOI_TIET_DU_LICH,
    CATEGORY.LIST_POST_THOI_TIET_NONG_VU,
    CATEGORY.LIST_POST_THOI_TIET_GIAO_THONG,
    CATEGORY.LIST_POST_THOI_TIET_NGUY_HIEM,
    CATEGORY.LIST_POST_THUY_VAN,
    CATEGORY.LIST_POST_TRANG_THAI_THOI_TIET,
];
